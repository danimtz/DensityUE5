...
#include "DensAT_PlayMontageMeshAndWaitEvent.generated.h"

class UDensAbilitySystemComponent;

/** Delegate type used, EventTag and Payload may be empty if it came from the montage callbacks */
DECLARE_DYNAMIC_MULTICAST_DELEGATE_TwoParams(FDensPlayMontageMeshAndWaitEventDelegate, FGameplayTag, EventTag, FGameplayEventData, EventData);
 ...
 */
UCLASS()
class DENSITY_API UDensAT_PlayMontageMeshAndWaitEvent : public UAbilityTask
{
	GENERATED_BODY()
	
public:
	// Constructor and overrides
	UDensAT_PlayMontageMeshAndWaitEvent(const FObjectInitializer& ObjectInitializer);
	...
	*/
	...
	FDensPlayMontageMeshAndWaitEventDelegate OnCompleted;

	/** The montage started blending out */
	UPROPERTY(BlueprintAssignable)
	FDensPlayMontageMeshAndWaitEventDelegate OnBlendOut;

	/** The montage was interrupted */
	UPROPERTY(BlueprintAssignable)
	FDensPlayMontageMeshAndWaitEventDelegate OnInterrupted;

	/** The ability task was explicitly cancelled by another ability */
	UPROPERTY(BlueprintAssignable)
	FDensPlayMontageMeshAndWaitEventDelegate OnCancelled;

	/** One of the triggering gameplay events happened */
	UPROPERTY(BlueprintAssignable)
	FDensPlayMontageMeshAndWaitEventDelegate EventReceived;
	...
	static UDensAT_PlayMontageMeshAndWaitEvent* PlayMontageForMeshAndWaitForEvent(
...
private:
	...
	UDensAbilitySystemComponent* GetTargetASC();
