...
#include "DensGATargetActor_WeaponProjectile.generated.h"

class UDensWeaponInstance_Projectile;

UCLASS()
class DENSITY_API ADensGATargetActor_WeaponProjectile : public AGameplayAbilityTargetActor
{
	GENERATED_BODY()

public:
	ADensGATargetActor_WeaponProjectile();
	...
	**/
	...
	void Configure(
		UPARAM(DisplayName = "WeaponInstance") UDensWeaponInstance_Projectile* WeaponInstance,
	...
	UDensWeaponInstance_Projectile* WeaponInstance;
